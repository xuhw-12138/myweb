$(function(){
    ...
    var musicImgsData = ['/static/img/m1.jpg','/static/img/m2.jpg','/static/img/m3.jpg']    // 图片地址数组
    var musicNameData = ['出山','盗将行','归去来兮'];                   // 歌曲名数组
    var artistNameData = ['花粥/王胜娚','花粥/马雨阳','花粥']            // 创作歌手数组
    var musicUrls=['/static/mp3/music1.mp3','/static/mp3/music2.mp3','/static/mp3/music3.mp3'];// 歌曲mp3数组
